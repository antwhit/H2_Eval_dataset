...
public class dnsTSIGRecord extends dnsRecord {
    ...
    dnsTSIGRecord(dnsName rname, short rclass, int rttl, dnsName alg, Date timeSigned, short fudge, byte[] signature, short error, byte other[]) {
        this(rname, rclass);
        this.rttl = rttl;
        this.alg = alg;
        ...
        this.error = error;
        this.other = other;
        this.rlength = (short) (14 + alg.length() + signature.length + other.length);
    }
