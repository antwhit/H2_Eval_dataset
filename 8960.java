...
public class T6410643 extends ToolTester {
    ...
    void testGetTask(Iterable<String> options, Iterable<String> classes, Iterable<? extends JavaFileObject> compilationUnits) {
        try {
    ...
    void test(String... args) {
        ...
        if (task.call()) throw new AssertionError("Error expected");
