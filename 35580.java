...
public class HitWallGestureImpl extends DefaultDispatchable<GestureListener<HitWallGestureResult>> implements HitWallGesture {
    ...
    public HitWallGestureImpl(final BodyPart bodyPart, final Direction direction, final double triggerValue, final boolean checkTriggerForHigher) {
        this.bodyPart = bodyPart;
        this.direction = direction;
        this.triggerValue = triggerValue;
        this.checkTriggerForHigher = checkTriggerForHigher;
        this.triggerValueDeviation = this.triggerValue + (this.checkTriggerForHigher ? -DEVIATION_TOLERANCE : DEVIATION_TOLERANCE);
        LOG.debug("new HitWallGesture(filterer, jointType=" + bodyPart + ", direction=" + direction + ", " + "triggerValue=[" + triggerValue + "], checkTriggerForHigher=" + checkTriggerForHigher + ") ... " + "triggerValueDeviation=[" + this.triggerValueDeviation + "]");
    }
    ...
    @Override
    public final void onJointMessage(final JointMessage message) {
