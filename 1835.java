...
public class minherit2_runme {
    ...
    public static void main(String argv[]) {
        try {
            ...
            if (!Modifier.isAbstract(method.getModifiers())) throw new RuntimeException("asyncmethod should be abstract");
            method = IRemoteSyncIO.class.getDeclaredMethod("syncmethod", (java.lang.Class[]) null);
            if (!Modifier.isAbstract(method.getModifiers())) throw new RuntimeException("syncmethod should be abstract");
