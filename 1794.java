...
public class DragAndDropExample extends WOComponent {
    ...
    public WOActionResults droppedDraggable1() {
        System.out.println("DragAndDropExample.droppedDraggableID: draggable ID '" + droppedDraggableID + "' dropped onto 1: " + droppedDraggableID);
    ...
    public WOActionResults droppedDraggable2() {
        System.out.println("DragAndDropExample.droppedDraggableID: draggable ID '" + droppedDraggableID + "' dropped onto 2: " + droppedObject);
