...
public class T6412669 extends AbstractProcessor {
    ...
    public static void main(String... args) throws Exception {
        ...
        if (!ok) throw new AssertionError("compilation of test program failed");
        if (!out.contains("processing element")) throw new AssertionError("expected text not found in compilation output");
    }
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        if (count == 0) m.printMessage(Diagnostic.Kind.NOTE, "no annotations found");
        return true;
    }
