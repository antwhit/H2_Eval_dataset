...
public abstract class SubWriterHolderWriter extends HtmlStandardWriter {
    ...
    public void printSummaryLinkType(AbstractSubWriter mw, ProgramElementDoc member) {
        trBgcolorStyle("white", "TableRowColor");
    ...
    public void printSummaryLinkComment(AbstractSubWriter mw, ProgramElementDoc member) {
        codeEnd();
        println();
        br();
