...
public class T6824493 {
    ...
    void run() {
        ...
        if (errors > 0) throw new Error(errors + " errors found");
    }

    void test(String option, String... expect) {
        String[] args = { "-c", "-classpath", testSrc + File.pathSeparator + testClasses, option, "Test" };
        ...
        for (String e : expect) {
            if (!out.contains(e)) error("Not found: " + e);
        }
    }
