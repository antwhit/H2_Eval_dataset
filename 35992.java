...
public class Elemento {
	 ...
	 */
    public Elemento(int posX, int posY, Image image, Component padre) {
        this.posX = posX;
        this.posY = posY;
    ...
    /**
	 * Checa si el objeto <code>Elemento</code> intersecta a otro <code>Elemento</code>
	 *
	 * @return un valor boleano <code>true</code> si lo intersecta <code>false</code>
	 * en caso contrario
	 */
    public boolean intersecta(Elemento obj) {
