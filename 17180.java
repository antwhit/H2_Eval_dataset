...
public class Jetspeed2CodeGenerator {
    ...
    private void run() throws Exception {
        try {
            String[] argvPortlet = { "../" + project + "/web/WEB-INF/web.xml", "../" + project + "/web/WEB-INF/portlet.xml", project };
            PortletXmlPG.main(argvPortlet);
            String[] argvFolder = { "../" + project + "/web/WEB-INF/web.xml", pagesDir + "/" + project + "/folder.metadata", project };
            Jetspeed2FolderPG.main(argvFolder);
            String[] argvDs = { "../" + project + "/web/WEB-INF/web.xml", pagesDir + "/" + project + "/" + project + ".ds", project };
            ...
            for (Iterator it = app.getMetaModules().iterator(); it.hasNext(); ) {
                ...
                String[] argvPsml = { "../" + project + "/web/WEB-INF/web.xml", pagesDir + "/" + project + "/" + module.getName() + ".psml", project, module.getName() };
