...
public class TimerQuestion {
    ...
    private String[] domande = { "Chi canta 'Rainbow' ? (Nome e Cognome)", "Chi ha scritto: 'Il nome della rosa' ? (Nome e Cognome)", "3*4-22 = ?", "Il colore dei caschi dell'Onu", "Il festival del cinema della Palma d'Oro", "Bob, poetico cantautore americano", "Clint, interprete di 'Per un pugno di dollari'", "Leggendario capo Apache", "Il vero cognome di Ollio", "Lo era la Leggerezza dell'essere di Kundera", "Insetto luminoso", "La regione con Isernia" };
