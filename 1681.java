...
public class EmacspeakServer extends TTSServer {
    ...
    private String synthesizerName = System.getProperty("synthesizerName", "Unlimited domain FreeTTS Speech Synthesizer from Sun Labs");
    ...
    private Voice kevinHQ = new Voice("kevin16", Voice.GENDER_DONT_CARE, Voice.AGE_DONT_CARE, null);
    ...
    private void loadSynthesizer() {
        SynthesizerModeDesc modeDesc = new SynthesizerModeDesc(synthesizerName, modeName, locale, running, voices);
        try {
    ...
    protected void spawnProtocolHandler(Socket socket) {
        try {
            EmacspeakProtocolHandler handler = new EmacspeakProtocolHandler(socket, synthesizer);
