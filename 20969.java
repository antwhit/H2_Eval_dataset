 ...
 * @author Dave Grove
 */
public final class VM_AllocatorHeader extends VM_CommonAllocatorHeader implements VM_Uninterruptible {
   ...
   */
    public static void initializeHeader(Object ref, Object[] tib, int size, boolean isScalar) {
        ...
        VM_RCBuffers.addTibIncAndObjectDec(VM_Magic.objectAsAddress(tib), VM_Magic.objectAsAddress(ref), proc);
   ...
   * @param isScalar are we initializing a scalar (true) or array (false) object?
   */
    public static void initializeHeader(BootImageInterface bootImage, int ref, Object[] tib, int size, boolean isScalar) {
