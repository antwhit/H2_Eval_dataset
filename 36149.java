...
public class java_director_runme {
    ...
    public static void main(String argv[]) {
        ...
        if (instances != 4) throw new RuntimeException("Quux instances should be 4, actually " + instances);
        ...
        if (instances != 0) throw new RuntimeException("Quux instances should be 0, actually " + instances);
        Quux1 quux1 = new Quux1("quux1");
        if (quux1.disconnectMethodCalled) throw new RuntimeException("Oops");
        quux1.delete();
        if (!quux1.disconnectMethodCalled) throw new RuntimeException("disconnect method not called");
    }
