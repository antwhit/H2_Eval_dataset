...
class TestStackTrace {
    ...
    TestStackTrace() throws Exception {
        try {
    ...
    static void testHardwareException() throws Exception {
        int i = 1;
        int j = 0;
        int k = i / j;
        SystemOut.println(k);
    ...
    static void testSoftwareException() throws Exception {
        Float f = Float.valueOf("abc");
        SystemOut.println(f);
    }

    static void testUserException() throws Exception {
        throw new IOException();
    }

    static void testRethrownException() throws Exception {
        new TestStackTrace();
    }
    ...
    static void testAll() throws Exception {
        PrintWriter out = new PrintWriter(new FileOutputStream("Exception.pw"));
        for (int i = 1; i <= 4; ++i) {
