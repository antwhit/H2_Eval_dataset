...
public class Clash {
    ...
    public static void main(String[] args) {
        ...
        try {
            Proxy.newProxyInstance(Clash.class.getClassLoader(), new Class[] { Interface1A.class, Interface1A.class }, handler);
            System.err.println("Dupe did not throw expected exception");
        } catch (IllegalArgumentException iae) {
            System.out.println("Dupe threw expected exception");
        }
        try {
            Proxy.newProxyInstance(Clash.class.getClassLoader(), new Class[] { Interface1A.class, Interface1B.class }, handler);
