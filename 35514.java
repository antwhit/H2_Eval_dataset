...
public class Tangent {
    ...
    public boolean equals(Object obj) {
        ...
        if (c1b != other.c1b) return false;
        if (c1e != other.c1e) return false;
        if (c2 != other.c2) return false;
        if (c3 != other.c3) return false;
        if (c4b != other.c4b) return false;
        if (c4e != other.c4e) return false;
        if (r1 != other.r1) return false;
        if (r2b != other.r2b) return false;
        if (r2e != other.r2e) return false;
        if (r3b != other.r3b) return false;
        if (r3e != other.r3e) return false;
