...
public class T6392782 {
    ...
    public static void main(String... args) throws IOException {
        ...
        Iterable<? extends JavaFileObject> files = fm.getJavaFileObjectsFromFiles(Arrays.asList(new File(testSrc, T6392782.class.getName() + ".java")));
    ...
    private static void check(TreeScanner<?, ?> scanner, int expect, int found) {
        if (found != expect) throw new AssertionError(scanner.getClass().getName() + ": expected: " + expect + " found: " + found);
    }
