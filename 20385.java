...
public class FixturesTest extends UnitTest {
    ...
    public void loadData() {
        ...
        assertEquals(2, Vendor.find("SELECT DISTINCT v.id " + "FROM Vendor v " + "JOIN v.tags as t " + "WHERE t.label IN ('China', 'Wedding') " + "GROUP BY v.id HAVING count(t.id) = 2 ").fetch().size());
