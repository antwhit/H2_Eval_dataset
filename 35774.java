...
public final class OvertoneInst extends jm.audio.Instrument {
	...
	*/
    public void createChain() {
        Oscillator osc0 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate, this.channels);
        Volume vol0 = new Volume(osc0, (float) 1.0);
        Oscillator osc1 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate, this.channels);
        osc1.setFrqRatio((float) 2.0);
        Volume vol1 = new Volume(osc1, (float) 0.5);
        Oscillator osc2 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate, this.channels);
        osc2.setFrqRatio((float) 3.0);
        Volume vol2 = new Volume(osc2, (float) 0.25);
        Oscillator osc3 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate, this.channels);
        ...
        Envelope env = new Envelope(adder, new double[] { 0.0, 0.0, 0.1, 1.0, 1.0, 0.0 });
