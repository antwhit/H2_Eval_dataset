...
public final class OPT_SysMethodOperand extends OPT_Operand {
   ...
   */
    OPT_SysMethodOperand(String name) {
        ...
        if (ip == null) throw new OPT_OptimizingCompilerException("system call method does not exist: " + name);
   ...
   */
    boolean similar(OPT_Operand op) {
        ...
        if (op instanceof OPT_SysMethodOperand) nat = (OPT_SysMethodOperand) op; else return false;
