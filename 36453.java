...
class VM_BaselineCompiler {
    ...
    static VM_BASEOptions options;

    static VM_BASEOptions setUpOptions;
   ...
   */
    static void postBootOptions() {
        if ((setUpOptions.hasMETHOD_TO_PRINT() && setUpOptions.fuzzyMatchMETHOD_TO_PRINT("???")) || (setUpOptions.hasMETHOD_TO_BREAK() && setUpOptions.fuzzyMatchMETHOD_TO_BREAK("???"))) {
