public class ConstValInlining {
    ...
    void test() throws Exception {
        ...
        T t = new T();
        if (t.fnl_str.equals(reflected_fnl_str)) throw new Exception("FAILED: compiler failed to inline a qualified nonstatic constant");
    ...
    static class T extends test_ff {
        ...
        void test(String reflected) throws Exception {
            if (fnl_str.equals(reflected)) throw new Exception("FAILED: compiler failed to inline an unqualified nonstatic constant");
        }
    }
