...
public class rname_runme {
    ...
    public static void main(String argv[]) {
        ...
        if (!base.newname(10.0).equals("Base")) throw new RuntimeException("base.newname");
        RenamedDerived derived = new RenamedDerived();
        derived.func(base, base, base);
        if (!derived.newname(10.0).equals("Derived")) throw new RuntimeException("derived.newname");
    }
}
