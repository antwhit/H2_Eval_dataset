...
public class FollowerRangeModel extends ConverterRangeModel implements ChangeListener {
    ...
    public int getMaximum() {
        ...
        if (DEBUG) {
            ...
            System.out.println("  dataModel.getMaximum = " + modelMax + "; multiply by " + multiplyBy + "; result: " + modelMax * multiplyBy);
        }
        return (int) (modelMax * multiplyBy);
    }

    public void setMaximum(int newMaximum) {
        dataModel.setMaximum((int) (newMaximum * (multiplier / dataModel.getMultiplier())));
    }
    ...
    public double getDoubleValue() {
        return dataModel.getDoubleValue() * dataModel.getMultiplier() / multiplier;
    }

    public void setDoubleValue(double newValue) {
        dataModel.setDoubleValue(newValue * multiplier / dataModel.getMultiplier());
    }
    ...
    public void setRangeProperties(int value, int extent, int min, int max, boolean adjusting) {
        ...
        dataModel.setRangeProperties(value * multiplyBy, extent, min, (int) (max * multiplyBy), adjusting);
    }
}
