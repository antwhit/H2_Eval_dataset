...
public class HCodeGenerator extends CodeGenerator {
    ...
    protected void generate(MetaComponent component, String componentsPath, String file) throws Exception {
        ...
        if (component.getMetaEntity().isPojoGenerated()) {
            ...
            String[] argv = { componentsPath + "/" + file, modelPath + "/" + component.getName() + ".java", getJavaPackage(), component.getName() };
            PojoPG.main(argv);
            ...
            while (itAggregatesBean.hasNext()) {
                ...
                String[] argvAg = { componentsPath + "/" + file, modelPath + "/" + aggregateName + ".java", getJavaPackage(), component.getName(), aggregateName };
            ...
            if (!component.isTransient()) {
                ...
                String[] argvMap = { componentsPath + "/" + file, mappingPath + component.getName() + ".hbm.xml", getJavaPackage(), component.getName() };
        ...
        while (itPersistentAggregates.hasNext()) {
            ...
            if (!component.isTransient()) {
                ...
                String[] argvMap = { componentsPath + "/" + file, mappingPath + aggregateName + ".hbm.xml", getJavaPackage(), component.getName(), aggregateName };
                HibernatePG.main(argvMap);
            }
        }
    }
