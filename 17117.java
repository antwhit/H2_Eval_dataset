...
class JNI12 {
   ...
   * using a global ref. */
    ...
    public static void main(String[] args) throws NoSuchMethodException, NoSuchFieldException {
        ...
        if (heldGlobal == null) {
            if (verbose) System.err.println("testGlobalCreationAndReturn returned null!");
        ...
        if (heldWeak == null) {
            if (verbose) System.err.println("testWeakCreationAndReturn returned null!");
            heldWeak = new Object();
        }
        if (verbose) {
        ...
        if (allTestPass) System.out.println("PASS: JNI_12"); else System.out.println("FAIL: JNI_12");
    }
