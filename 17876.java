...
public class BNField4 {
    ...
    public boolean equals(Object o) {
        ...
        return bn == w.bn && re.equals(w.re) && im.equals(w.im);
    }
    ...
    public BNField4 multiply(BNField4 w) {
        ...
        return new BNField4(bn, (bn.b == 3) ? b0c0.add(b1c1.divideV()) : b0c0.add(b1c1.multiplyV()), b0.add(b1).multiply(c0.add(c1)).subtract(b0c0).subtract(b1c1));
    }
    ...
    public BNField4 square() {
        ...
        return new BNField4(bn, (bn.b == 3) ? a02.add(a12.divideV()) : a02.add(a12.multiplyV()), a0.add(a1).square().subtract(a02).subtract(a12));
    }
