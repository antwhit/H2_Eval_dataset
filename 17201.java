...
public class T6350057 extends AbstractProcessor {
    ...
    static class LocalVarAllergy extends ElementKindVisitor6<Boolean, Void> {
        ...
        public Boolean visitTypeAsEnum(TypeElement e, Void v) {
            ...
            for (Element el : e.getEnclosedElements()) this.visit(el);
            return true;
        }
        ...
        public Boolean visitExecutableAsMethod(ExecutableElement e, Void v) {
            ...
            for (VariableElement ve : e.getParameters()) this.visit(ve);
            return true;
        }
    }

    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnvironment) {
        if (!roundEnvironment.processingOver()) for (Element element : roundEnvironment.getRootElements()) element.accept(new LocalVarAllergy(), null);
        return true;
    }
}
