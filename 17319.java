...
public class PackageIndexFrameWriter extends AbstractPackageIndexWriter {
    ...
    public static void generate() throws DocletAbortException {
        ...
        try {
            ...
            Standard.configuration().standardmessage.error("doclet.exception_encountered", exc.toString(), filename);
    ...
    protected void printIndexRow(PackageDoc pd) {
        ...
        printTargetHyperLink(pathString(pd, "package-frame.html"), "packageFrame", pd.name());
        fontEnd();
        br();
    }
    ...
    protected void printAllClassesPackagesLink() {
        fontStyle("FrameItemFont");
        printTargetHyperLink("allclasses-frame.html", "packageFrame", getText("doclet.All_Classes"));
        fontEnd();
        p();
