...
public class module {
    ...
    protected static final String T1_FORMAT = "{int, {enum : 3}, [double:2,3], double}";
    ...
    protected static class T2 {
        ...
        public String toString() {
            ...
            str += ">, ";
            str += (status == WaitVal ? "WaitVal" : status == SendVal ? "SendVal" : status == ReceiveVal ? "ReceiveVal" : status == ListenVal ? "ListenVal" : Integer.toString(status));
            return str + "]";
        }
    }
    ...
    protected static final String T2_FORMAT = "{string, int, <T1:2>, {enum WaitVal, SendVal, ReceiveVal, ListenVal}}";
