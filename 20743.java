...
class Env_Box {
    ...
    public void Draw(Graphics g) {
        for (int i = 0; i < boundaries.size(); i++) g.drawLine((int) (boundaries.get(i).vec.x1), (int) boundaries.get(i).vec.y1, (int) boundaries.get(i).vec.x2, (int) boundaries.get(i).vec.y2);
    }
}
