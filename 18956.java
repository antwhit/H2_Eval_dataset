...
class VM_Triplet {
   ...
   */
    static int dictionaryHash(VM_Triplet key) {
        return VM_Atom.dictionaryHash(key.a) + VM_Atom.dictionaryHash(key.b) + VM_Atom.dictionaryHash(key.c);
    }
   ...
   */
    static int dictionaryCompare(VM_Triplet leftKey, VM_Triplet rightKey) {
        if (leftKey == null) return 0;
        if (leftKey.a == rightKey.a && leftKey.b == rightKey.b && leftKey.c == rightKey.c) return 1;
        return -1;
    }
