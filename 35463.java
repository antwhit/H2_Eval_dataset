public final class _String {
    ...
    public boolean regionMathces(boolean ignoreCase, int toffset, String other, int ooffset, int len) {
        return true;
    }

    public boolean regionMathces(int toffset, String other, int ooffset, int len) {
        return true;
    }
