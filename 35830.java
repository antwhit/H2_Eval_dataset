...
public class GLESCodeEmitter extends JniCodeEmitter {
    ...
    /**
      */
    public GLESCodeEmitter(String classPathName, ParameterChecker checker, PrintStream javaImplStream, PrintStream cStream) {
    ...
    public void emitCode(CFunc cfunc, String original) {
        emitCode(cfunc, original, null, mJavaImplStream, mCStream);
    }
