...
public class EvadeObstacle implements Behavior {
    ...
    private void stopSmoothly() {
        ...
        while (System.currentTimeMillis() - startTime <= STOP_TIME) Thread.yield();
    }
    ...
    private void goBackwards() {
        ...
        while (System.currentTimeMillis() - startTime <= rand_back_time) Thread.yield();
    }
    ...
    private void leitura(double headAngle) {
        ...
        int average = 0;
        if (totalReads > 0) average = total / totalReads;
        ...
        if (average > 0 && average < 50) enviaMensagem((int) x, (int) y, 1);
    }
