...
class TestClassLoading {
    ...
    Class myLoader(String s) throws Exception {
    ...
    void arrayOfSimple() throws Exception {
    ...
    void arrayOfArrayOfSimple() throws Exception {
        Class c = myLoader("[[Ljava.lang.String;");
        SystemOut.println("class=" + c);
        String i[][] = (String[][]) c.newInstance();
        SystemOut.println("instance=" + i + " len=" + i.length);
    ...
    void arrayOfPrimitive() throws Exception {
        Class c = myLoader("[I");
        SystemOut.println("class=" + c);
    ...
    void arrayOfArrayOfPrimitive() throws Exception {
        Class c = myLoader("[[I");
        SystemOut.println("class=" + c);
        int i[][] = (int[][]) c.newInstance();
        SystemOut.println("instance=" + i + " len=" + i.length);
