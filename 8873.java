...
class logic {
    ...
    static int eje(int a) {
        if (aja(a)) return 0; else return 1;
    }

    static int iji(int a) {
        if (aja(a)) return 3; else return 5;
    }

    static int ojo(int a, int b) {
        if (ajaja(a, b)) return 3; else return 5;
    }
    ...
    static int uju1() {
        if (array != null) return array[1];
        return 0;
    }

    static int test(int a) {
        if ((a & 0xf) == 0) return 3; else return 5;
    }
