...
public class SlotTable extends DatabaseTable {
    ...
    public SlotTable(Break _break) throws SQLException {
    ...
    private static String getSQL(Break _break) {
        return "SELECT position,spot,sponsor,title,year " + "FROM view_slot " + "WHERE break=" + _break.getId() + " " + "ORDER BY position";
    }
