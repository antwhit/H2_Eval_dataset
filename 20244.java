...
public class TestCircularClassfile {
    ...
    static class JavaSource extends SimpleJavaFileObject {
        ...
        static final String sourceStub = "class #C extends #S {}";
    ...
    static JavaSource[] initialSources = new JavaSource[] { new JavaSource(ClassName.A, ClassName.OBJECT), new JavaSource(ClassName.B, ClassName.A), new JavaSource(ClassName.C, ClassName.B) };
    ...
    static class DiagnosticChecker implements DiagnosticListener<JavaFileObject> {
        ...
        public void report(Diagnostic<? extends JavaFileObject> diagnostic) {
            if (diagnostic.getKind() == Diagnostic.Kind.ERROR && diagnostic.getCode().equals("compiler.err.cyclic.inheritance")) {
                errorFound = true;
            }
        }
    }
