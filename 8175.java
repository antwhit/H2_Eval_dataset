...
public class NetworkDebugger {
   ...
   */
    ...
    private static final String COMMAND_DONE = "______Command_executed______";

    private static final String PROCESS_TERMINATED = "______Process_terminated______";
   ...
   * @see     jdp
   */
    public NetworkDebugger(int bp, String runner, boolean rawMode, boolean interpreted, String init_macro, boolean viewBoot) {
