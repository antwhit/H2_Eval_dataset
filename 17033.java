...
public class Test42 extends UISkeleton {

    public Test42() {
    }

    public Test42(String[] args) throws RemoteException, VisADException {
        super(args);
    }
    ...
    void setupServerData(LocalDisplay[] dpys) throws RemoteException, VisADException {
        ...
        ConstantMap[] omaps1;
        omaps1 = new ConstantMap[] { new ConstantMap(1.0, Display.Blue), new ConstantMap(1.0, Display.Red), new ConstantMap(0.0, Display.Green) };
        ...
        ConstantMap[] omaps2;
        omaps2 = new ConstantMap[] { new ConstantMap(1.0, Display.Blue), new ConstantMap(1.0, Display.Red), new ConstantMap(0.0, Display.Green) };
        dpys[1].addReference(ref_imaget1, null);
        dpys[1].addReference(ref_imaget2, omaps2);
    }

    String getFrameTitle() {
        return "image / contour alignment in Java3D";
    }
