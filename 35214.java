...
public class Variable extends Argument {
    ...
    public ArrayList<Object> priorValues, containedBy;
	...
	*/
    public Variable(String name) {
        if (name.equals("Ego")) argName = LiteralAbstract1.stdEgo; else if (name.equals("Alter")) argName = LiteralAbstract1.stdAlter; else if (name.length() == 1 && Character.isUpperCase(name.charAt(0))) argName = name.intern(); else argName = name;
        argType = stdVarType;
        valueType = "default".intern();
    }
	...
	*/
    ...
    public Object bindingVal() {
        if (getVal() != null) return getVal().get(0); else return null;
    }
