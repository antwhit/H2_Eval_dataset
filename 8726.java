...
class VM_CallSiteTripleComparator implements java.util.Comparator {
   ...
   */
    public int compare(Object o1, Object o2) {
        if (!(o1 instanceof VM_CallSiteTriple) || !(o2 instanceof VM_CallSiteTriple)) {
            VM.sysWrite("***VM_CallSiteTripleComparator.compare():" + " one object is not of type VM_CallSiteTriple\n");
            VM.sysExit(-1);
        }
        if (o1.equals(o2)) return 0;
        VM_CallSiteTriple t1 = (VM_CallSiteTriple) o1;
        VM_CallSiteTriple t2 = (VM_CallSiteTriple) o2;
        if (byWeight) return compareByWeight(t1, t2); else return compareByName(t1, t2);
    }
}
