...
public class testNode extends TestCase {
    ...
    private ArrayList<String> lineages = new ArrayList<String>(Arrays.asList("Bacteria; Actinobacteria; Actinobacteridae; Propionibacterineae; Propionibacterium", "Bacteria; Actinobacteria; Actinobacteridae; Gordoniaceae; Corynebacteriaceae", "Bacteria; Actinobacteria; Actinobacteridae", "Bacteria; Actinobacteria; Actinobacteridae; Gordoniaceae", "Bacteria; Proteobacteria; Gammaproteobacteria; Enterobacteriales", "Bacteria; Proteobacteria; Gammaproteobacteria; Pseudomonadaceae", "Bacteria; Proteobacteria; Gammaproteobacteria; Moraxellaceae", "Bacteria; Firmicutes; Alicyclobacillaceae; Alicyclobacillus; Bacillales", "Bacteria; Actinobacteria; Actinobacteridae"));
    ...
    public void testGetConsensusLineage100() {
        for (Node n : tree.nodes) n.setLineage(lineages.remove(0));
        for (Node n : tree.nodes) n.setConsensusLineage(n.getConsensusLineageF(1));
    ...
    public void testGetNumberOfLeaves() {
        for (Node n : tree.getNodes()) n.setNumberOfLeaves(n.getNumberOfLeavesF());
    ...
    public void testGetLeaves() {
        ...
        for (Node n : testNodes) testNames.add(n.getName());
    ...
    public void testDepth() {
        for (Node n : tree.getNodes()) n.setDepth(n.depthF());
